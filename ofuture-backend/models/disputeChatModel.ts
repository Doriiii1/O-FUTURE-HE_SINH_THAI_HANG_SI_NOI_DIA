...
class DisputeChatModel {
  ...
  static async getById(id: string): Promise<DisputeChat | null> {
    ...
    try {
      ...
      const [rows] = await conn.execute(query, [id]) as unknown as [DisputeChat[], unknown];
  ...
  static async getByDisputeId(
    ...
    try {
      ...
      `;
      const [rows] = await conn.execute(query, [disputeId]) as unknown as [DisputeChatWithSender[], unknown];
      return rows;
    } finally {
      conn.release();
    }
  ...
  static async getUnreadByDispute(
    ...
    try {
      ...
      `;
      const [rows] = await conn.execute(query, [disputeId, userId]) as unknown as [DisputeChat[], unknown];
      return rows;
    } finally {
      conn.release();
    }
  ...
  static async getByDisputeIdPaginated(
    ...
    try {
      ...
      const [messages] = await conn.execute(query, [
        disputeId,
        limit,
        offset,
      ]) as unknown as [DisputeChatWithSender[], unknown];
